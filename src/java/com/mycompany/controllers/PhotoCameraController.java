...
public class PhotoCameraController implements Serializable {
    ...
    public void onCapture(CaptureEvent captureEvent) {
        ...
        /*
         ...
         directory ThoughtwareStorage/PhotoStorage/. We do not assign a file extension to tmp_file
    ...
    private File inputStreamToFile(InputStream inputStream, String targetFilename) throws IOException {
        ...
        try {
            ...
            // Create a new empty file with the given name targetFilename in ThoughtwareStorage/PhotoStorage
            ...
            // Create the targetFile in ThoughtwareStorage/PhotoStorage with the inputStream given
    ...
    private void saveThumbnail(File inputFile, UserPhoto inputPhoto) {
        ...
        try {
            ...
            // Create the thumbnail photo file in ThoughtwareStorage/PhotoStorage
    ...
    public void deletePhoto() {
        ...
        if (!photoList.isEmpty()) {
            ...
            try {
                // Delete the photo file from ThoughtwareStorage/PhotoStorage
                Files.deleteIfExists(Paths.get(photo.getPhotoFilePath()));

                // Delete the thumbnail file from ThoughtwareStorage/PhotoStorage
                Files.deleteIfExists(Paths.get(photo.getThumbnailFilePath()));

                // Delete the temporary file from ThoughtwareStorage/PhotoStorage
                Files.deleteIfExists(Paths.get(photo.getTemporaryFilePath()));

                // Delete the photo file record from the ThoughtwareDB database

...
//return FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("isGoogleAccount").equals(true);
    ...
    public String updateAccount() throws NoSuchAlgorithmException {
        ...
        if (statusMessage == null || statusMessage.isEmpty()) {
            ...
            try {
                ...
                // Store the changes in the ThoughtwareDB database
    ...
    public String deleteAccount() {
        ...
        if (statusMessage == null || statusMessage.isEmpty()) {
            ...
            try {
                ...
                // Delete the User entity, whose primary key is user_id, from the ThoughtwareDB database
    ...
    public String userPhoto() {
        ...
        if (photoList.isEmpty()) {
            ...
            in ThoughtwareStorage/PhotoStorage.
             */
        ...
        Thus, JSF knows that 'ThoughtwareStorage/' is the document root directory.
         */
    ...
    public void deleteAllUserPhotos(int userId) {
        ...
        if (!photoList.isEmpty()) {
            ...
            try {
                ...
                // Remove the user's photo's record from the ThoughtwareDB database
        ...
        if (!userFilesList.isEmpty()) {
            ...
            for (int i = 0; i < userFilesList.size(); i++) {
                ...
                try {
                    ...
                    // Remove the user's file record from the ThoughtwareDB database

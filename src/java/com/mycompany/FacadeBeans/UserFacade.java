...
public class UserFacade extends AbstractFacade<User> {
    ...
    /*
    ----------------------------------------------------------------------------------------------------
    Annotating 'private EntityManager em;' with '@PersistenceContext(unitName = "ThoughtwarePU")'
    implies that the EntityManager instance pointed to by 'em' is associated with the 'ThoughtwarePU'
     ...
     */
    /**
     * @param id is the Primary Key of the User entity in a table row in the ThoughtwareDB database.
